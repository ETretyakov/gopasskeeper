...
const (
	Sync_Get_FullMethodName = "/files.Sync/Get"
)
...
type SyncClient interface {
	Get(ctx context.Context, in *SyncGetRequest, opts ...grpc.CallOption) (*SyncGetResponse, error)
}
...
func (c *syncClient) Get(ctx context.Context, in *SyncGetRequest, opts ...grpc.CallOption) (*SyncGetResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(SyncGetResponse)
	err := c.cc.Invoke(ctx, Sync_Get_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type SyncServer interface {
	Get(context.Context, *SyncGetRequest) (*SyncGetResponse, error)
...
func (UnimplementedSyncServer) Get(context.Context, *SyncGetRequest) (*SyncGetResponse, error) {
...
func _Sync_Get_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(SyncGetRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(SyncServer).Get(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Sync_Get_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(SyncServer).Get(ctx, req.(*SyncGetRequest))
	}
...
var Sync_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "files.Sync",
	HandlerType: (*SyncServer)(nil),
	Methods: []grpc.MethodDesc{
		{
			MethodName: "Get",
			Handler:    _Sync_Get_Handler,
		},
	},
